                ...
                <div class="border rounded-3 p-3 mt-4">
                    ...
                    <div class="form-row">
                        <div class="form-check">
                            <input class="form-check-input checker me-3" data-checker="required" type="checkbox" value="" name="agree_policy" id="agree_policy">
                        ...
                        <div id="collapseTwo" class="accordion-collapse collapse">
                            <div class="accordion-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <select class="form-control mb-3 checker" name="city" data-checker="required" name="city" id="city">
                        ...
                        <div id="collapseThree" class="accordion-collapse collapse">
                            <div class="accordion-body">
                                ...
                                <div class="form-row">
                                    ...
                                    <select class="form-control mb-3 checker" data-checker="required" name="city2" id="city2">
                                        <option value="" selected>Select City</option>
                                        <option value="-">-</option>
                                    </select>
                                </div>
